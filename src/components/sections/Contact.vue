  ...
  <section id="contact" class="py-32 min-h-[60vh] flex flex-col justify-center layout-container">
    ...
    <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
      ...
      <div class="flex items-center gap-8 lg:hidden">
        <a href="https://www.linkedin.com/in/vinita-kumbhar/" target="_blank" rel="noopener noreferrer" class="text-soft-gray hover:text-celadon transition-colors" aria-label="LinkedIn">
        ...
        <a href="https://github.com/VinitaPotter" target="_blank" rel="noopener noreferrer" class="text-soft-gray hover:text-celadon transition-colors" aria-label="GitHub">
        ...
        <a href="https://medium.com/@vinitapotter" target="_blank" rel="noopener noreferrer" class="text-soft-gray hover:text-celadon transition-colors" aria-label="Medium">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current" viewBox="0 0 24 24"><path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"/></svg>
        </a>
      </div>
    </div>
  </section>
